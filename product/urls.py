...
from product.views import log_in, log_out, sign_up, ItemDetailView, about, add_to_cart, remove_from_cart, store, HomeView, profile, edit_profile, home, remove_single_cart, delete, products
